 ...
 * @Entity
 * 
 * @Table(name = "ESTADO_INVENTARIO") public class Inventario implements
 * Serializable {
 * 
 *//**
	* 
	*//*
		 ...
		 * @Id
		 * 
		 * @Column(name = "ID_ESTADO_INVENTARIO") private String idEstadoInventario;
		 * 
		 * @Column(name = "DESCRIPCION") private String descripcion;
		 * 
		 * public String getIdEstadoInventario() { return idEstadoInventario; }
		 * 
