...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService userDetailsService() {
    	...
    	UserDetails user=User.builder().username("user").password(passwordEncoder().encode("123")).
    			roles("USER").build();
    	UserDetails userAdmin=User.builder().username("admin").password(passwordEncoder().encode("123")).
    			roles("ADMIN").build();
